...
def _get_total() -> uint256:
    ...
    for i in range(500):
        ...
        for gauge_type in range(100):
            if gauge_type == _n_gauge_types:
                break
            type_sum: uint256 = self.points_sum[gauge_type][t].bias ## to check
...
def add_gauge(addr: address, gauge_type: int128, weight: uint256 = 0):
    ...
    this_time: uint256 = (block.timestamp) / WEEK * WEEK
    ...
    if weight > 0:
        ...
        self.points_sum[gauge_type][this_time].bias = weight + _old_sum
        self.points_sum[gauge_type][next_time].bias = weight + _old_sum
        self.time_sum[gauge_type] = next_time
        self.points_total[this_time] = _old_total + _type_weight * weight
        self.points_total[next_time] = _old_total + _type_weight * weight
        self.time_total = next_time

        self.points_weight[addr][this_time].bias = weight
...
def _change_type_weight(type_id: int128, weight: uint256):
    ...
    self.points_total[this_time] = _total_weight
    self.points_total[next_time] = _total_weight
    self.points_type_weight[type_id][this_time] = weight
